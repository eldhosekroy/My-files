...
public class Calculator implements ActionListener{
		...
		jf.add(displayLable);
			...
			jf.add(zeroButton);
						...
						jf.add(equalButton);
								...
								clearButton.setBounds(430, 420, 122, 80);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==sevenButton) {
			...
			newvarable=displayLable.getText();
			
			float oldValueF=Float.parseFloat(oldvarable);
			float newValueF=Float.parseFloat(newvarable);
			
			switch(oprators) {
			
			case 1:
				answer=oldValueF/newValueF;
				displayLable.setText(answer+"");
				break;
			...
			isClicked=true;
			oldvarable=displayLable.getText();
			oprators=1;
